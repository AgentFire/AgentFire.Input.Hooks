...
public static class HardwareInput
{
    ...
    public static void KeyInput(Key key, bool isPressed)
    {
        ...
        InputData[0].ki.Scan = (short)scan;
        InputData[0].ki.Flags = (int)(isPressed ? WinApi.KeyboardFlag.KeyDown : WinApi.KeyboardFlag.KeyUp) | (int)WinApi.KeyboardFlag.ScanCode;
        InputData[0].ki.Time = 0;
        InputData[0].ki.ExtraInfo = 0;
    ...
    public static void MouseInput(MouseButton button, bool isPressed)
    {
        ...
        InputData[0].mi.Flags = (int)MouseFlag;
